...
use ethers_compile::artifacts::{BytecodeObject, CompactBytecode, CompactContractBytecode};
...
mod tests {
    ...
    use ethers::{
        abi::Abi,
        compile::{artifacts::CompactContractBytecode, Project, ProjectPathsConfig},
        types::{Address, Bytes},
    };
    use std::path::PathBuf;

    #[test]
    #[ignore] // TODO: This needs to be re-enabled one it's fixed in ethers-compile.
    fn test_linking() {
